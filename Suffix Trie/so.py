...
output = open("ls.txt", "w")
# abre o arquivo ls sem os id para escrita                                    
outputWithoutID = open("ls-without-id.txt", "w")
# abre o arquivo grep para escrita
outputGrep = open("grep.txt", "w")
# abre o arquivo grep semos id para escrita 
outputGrepWithoutID = open("grep-without-id.txt", "w")

# abre o primeiro arquivo ls gerado
with open("ls_log.txt") as file:
...
with open("grep_log.txt") as file:
...
sliding_window("ls-without-id.txt", "ls")
# chama a função que gera as janelas de grep
sliding_window("grep-without-id.txt", "grep")
# chama a função que detecta se o programa está infectado   
infected("window-ls.txt", "window-ls.txt")
